window.addEventListener('load', () => {
    ...
    console.log(list_el)
    // create variable to number the tasks
   var number_the_tasks =0;
    ...
    form.addEventListener('submit', (e) => {
        ...
        const task = input.value;
          var count = number_the_tasks + "." + input.value;
        ...
        // Function to prevent null value
        if(task==''){
